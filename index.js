        ...
        const promise = new Promise((resolve, reject) => {
            userPrompts()
                .then(function ({ name, id, email, title }) {
                    ...
                    if (title === "Manager") {
                        userManager().then(function ({ officeNumber }) {
                        ...
                        userEngineer().then(function ({ github }) {
                       ...
                       userIntern().then(function ({ school }) {
        ...
        for (j = 0; j < maxTimes; j++) {
            ...
            html += `<div class="card bg-light justify-content-center align-items-center" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush text">
                    ...
                    <li class="list-group-item"> ${userType(employeeArray[j])}</li>
                </ul>
            </div > `;
        }
        return html;
    ...
    <title>My Team</title>
     <style>
            ...
            .card {
                ...
                color: rgb(131, 22, 240);
                margin: 15px;
            }
            .text {
                padding: 15px;
                border-radius: 6px;
                background-color: rgb(163, 127, 233);
                color: rgb(131, 22, 240;
                margin: 15px;
            }
            .col {
